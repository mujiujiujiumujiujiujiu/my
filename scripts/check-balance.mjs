...
const baselineFormations = {
  ...
  5: ['gazi', 'gazi', 'dayun', 'caixukun', 'naima'],
  6: ['gazi', 'gazi', 'dayun', 'caixukun', 'naima', 'miaocuijiao', 'couqie'],
  7: ['gazi', 'gazi', 'gazi', 'caixukun', 'naima'],
  8: ['gazi', 'dayun', 'naima', 'caixukun', 'caixukun', 'gugugaga', 'dagou', 'miaocuijiao', 'couqie', 'couqie'],
  9: ['gugugaga', 'dayun', 'niulai', 'gazi', 'gugugaga', 'gazi', 'maodie', 'gazi', 'gazi', 'daodun'],
  10: ['huangsedashu', 'couqie', 'caixukun', 'huangsedashu', 'huangsedashu', 'maodie', 'naima', 'dayun', 'gazi', 'dagou', 'naima', 'gazi'],
};
